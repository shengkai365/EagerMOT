...
POINTGNN_DETS_DIR = MOUNT_PATH + "/eagermot_workspace/detections_pointgnn/" + SPLIT
DETECTIONS_AB3DMOT = MOUNT_PATH + "/eagermot_workspace/ab3dmot/" + SPLIT
DETECTIONS_EFFICIENT_DET_NUSCENES = MOUNT_PATH + "/eagermot_workspace/efficientdet/" + SPLIT
DETECTIONS_CENTER_POINT_NUSCENES = MOUNT_PATH + "/eagermot_workspace/centerpoint/" + SPLIT

SEGMENTATIONS_TRACKRCNN_DIR = MOUNT_PATH + "/eagermot_workspace/trackrcnn/" + SPLIT
MOTSFUSION_RRC_DIR = MOUNT_PATH + "/eagermot_workspace/detections_segmentations_RRC_BB2SegNet/" + SPLIT
MOTSFUSION_TRACKRCNN_DIR = MOUNT_PATH + "/eagermot_workspace/detections_segmentations_trackrcnn_BB2SegNet/" + SPLIT
DETECTIONS_MMDETECTION_CASCADE_NUIMAGES_NUSCENES = MOUNT_PATH + \
    "/eagermot_workspace/mmdetection_cascade_x101/" + SPLIT
DETECTIONS_MMDETECTION_CASCADE_NUIMAGES_KITTI = MOUNT_PATH + \
    "/eagermot_workspace/mmdetection_cascade_x101_kitti/" + SPLIT
...
DETECTIONS_3DOP_PATH = MOUNT_PATH + "/eagermot_workspace/3dop/" + SPLIT
