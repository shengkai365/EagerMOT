...
class MOTSequence(ABC):
    def __init__(self, detections_dir_3d: str, detections_dir_2d: str, split_dir: str, name: str, frame_names: Iterable[str]):
        self.detections_dir_3d = detections_dir_3d
        self.detections_dir_2d = detections_dir_2d
        ...
        det_detections_dir_2d_folder_name = f'{self.detections_dir_3d}_{self.detections_dir_2d}'
        self.work_split_input_dir = os.path.join(self.split_dir, det_detections_dir_2d_folder_name)
    ...
    def perform_tracking_for_eval(self, params: Mapping[str, Any]) -> Dict[str, Any]:
        ...
        mot_3d_file = io.create_writable_file_if_new(self.get_results_folder_name(params, folder_identifier, "3d"), self.name)
        
        mot_2d_from_3d_file = io.create_writable_file_if_new(self.get_results_folder_name(params, folder_identifier, "2d_projected_3d"), self.name)
