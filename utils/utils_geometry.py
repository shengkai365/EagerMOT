...
# def tracking_distance_pos_dims_weight(center_0, center_1, dims_0, dims_1, weight):
#     a = np.linalg.norm(center_0[np.array((0, 1, 2))] - center_1[np.array((0, 1, 2))])
#     b = np.linalg.norm(dims_0[np.array((0, 2))] - dims_1[np.array((0, 2))])
